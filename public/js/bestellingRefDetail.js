...
function fillContainerWithData(data) {
  ...
  bestellingData = _data
  console.log('Data fillContainer', _data)
  const container = document.getElementById('bestellingenTabel')
...
<tr>
  ...
  <td></td>
  <td >Kleur onderlat</td>
  <td >${ral + element.kleuronderlat +aecode}</td>
  <td ></td>
  <td ></td>
  <td ></td>
  <!-- voeg andere kolommen toe indien nodig -->
  ...
  `
            ...
            if (element.ralonderlat) {
              value += `
                <tr>
                  <td></td>
                  <td >Kleur onderlat</td>
                  <td >${"RAL " + element.ralonderlat + ' - ' + element.kleuronderlat}</td>
                  <td ></td>
                  <td ></td>
                  <td ></td>
                  <!-- voeg andere kolommen toe indien nodig -->
      ...
      <td >${(zender.feryn === true) ? 0 : element.Tradizenderkorting}</td>
      ...
      <!-- voeg andere kolommen toe indien nodig -->
          ...
          if (element.schakelaarprijs && element.schakelaarprijs > 0) {
            ...
            value += `<tr>
              ...
              <td >${formaatGetal(element.aantal,element.schakelaarprijs)}</td>
          ...
          if (_data && _data !== "geen") {
            ...
            <td >${formaatGetal(element.aantal,zenderElement.prijs)}</td>
        ...
        const netto = (element.feryndb === 1) ? Math.round(element.vzrprijs) : Math.round(Number((element.vzrprijs - (element.vzrprijs * element[korting] / 100)).toFixed(2)))
  ...
  <!-- voeg andere kolommen toe indien nodig -->
        ...
        if (element.geleiderstoppen != "geen" && element.geleiderstoppen != null && element.geleiderstoppen != 0) {
          const korting = element.typelamel + element.typebediening + element.type + 'korting';
        ...
        if (element.type) {
          ...
          const netto = Math.round(Number((element.screenprijs - (element.screenprijs * element[korting] / 100)).toFixed(2)))
    ...
    <!-- voeg andere kolommen toe indien nodig -->
        ...
        <!-- voeg andere kolommen toe indien nodig -->
                  ...
                  const netto = (zender.feryn === true) ? Number(zender.prijs) : Number((zender.prijs - (zender.prijs * element.screenzenderkorting / 100)).toFixed(2))
                  brutoStuk += zender.prijs * zender.aantal
                  totaalBruto += Number(zender.prijs) * Number(zender.aantal)
                  nettoStuk += netto * zender.aantal
                  totaalNetto += netto * zender.aantal
        ...
        <td >${formaatGetal(zender.aantal,zender.prijs.toFixed(2))}</td>
        <td >${(zender.feryn === true) ? 0 :element.screenzenderkorting}</td>
        <td >${formaatGetal(zender.aantal,netto)}</td>
        <!-- voeg andere kolommen toe indien nodig -->
        </tr>`
...
<tr style="color : red;">
    ...
    <td>${formaatGetal(1,(brutoStuk).toFixed(2))}</td>
    <td></td>
    <td><b>${formaatGetal(1,(nettoStuk).toFixed(2))}</b></td>
    <!-- voeg andere kolommen toe indien nodig -->
  </tr>
  ...
  value += `
    <tbody>
      ...
      <td style="color:#000080"></td>
        ...
        <td><b>${formaatGetal(1,totaalBruto.toFixed(2))}</b></td>
        <td style="color:#000080"><b>Netto totaal:</b></td>
        <td><b>${formaatGetal(1,totaalNetto.toFixed(2))}</b></td>
      </tr>
      <tr>
      <td></td>
      <td></td>
      ...
      <td style="color:#000080"></td>
        ...
        <td><b>${formaatGetal(1,(totaalNetto/100*21).toFixed(2))}</b></td>
      </tr>
      <tr>
      <td></td>
      <td></td>
      ...
      <td style="color:#000080"></td>
        ...
        <td style="color : red;"><b>${formaatGetal(1,(totaalNetto*1.21).toFixed(2))}</b></td>
      </tr>
    </tbody>
  </table>
</div>
...
fillContainerWithData(bestelling)
